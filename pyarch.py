...
class terminal_t:
	...
	def enable_curses (self):
		...
		subwin_x = x//3 # Linha alterada pra funcionar em python 3

		self.wins = []

		self.wins.append( terminal_video_buffer_t(self.stdscr.subwin(y, subwin_x, 0, subwin_x*0)) )
		self.wins.append( terminal_video_buffer_t(self.stdscr.subwin(y - (y//4)*3, subwin_x, (y//4)*3, subwin_x*1)) ) # Linha alterada pra funcionar em python 3
		self.wins.append( terminal_video_buffer_t(self.stdscr.subwin(y, subwin_x, 0, subwin_x*2)) )
		self.wins.append( terminal_video_buffer_t(self.stdscr.subwin((y//4)*3, subwin_x, 0, subwin_x*1)) ) # Linha alterada pra funcionar em python 3
